...
const Layout: React.FC = () => {
  ...
  const navigation = [
    ...
    { name: 'Billboard', href: '/billboard', icon: Monitor },
      ...
      <div className="lg:pl-64">
        ...
        <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            ...
            {state.selectedEvent && (
              <div className="flex items-center gap-x-3 bg-blue-50 border border-blue-200 rounded-lg px-3 py-2">
                <Calendar className="h-4 w-4 text-blue-600" />
                <div className="flex flex-col">
                  <span className="text-sm font-medium text-blue-900">{state.selectedEvent.name}</span>
                  <div className="flex items-center gap-x-2 text-xs text-blue-700">
                    <span>{state.selectedDate}</span>
                    {state.selectedEvent.time && (
                      <>
                        <span>•</span>
                        <Clock className="h-3 w-3" />
                        <span>{state.selectedEvent.time}</span>
                      </>
                    )}
                  </div>
                </div>
